...
//Rollers
import BakunawaRoller from "../Assets/DiceImg/BakunawaRoller.png";
import BakunawaRollerG from "../Assets/DiceImg/BakunawaRollerG.png";
import BakunawaRollerR from "../Assets/DiceImg/BakunawaRollerR.png";
import CastleRoller from "../Assets/DiceImg/CastleRoller.png";
import BakunawiJr from "../Assets/DiceImg/BakunawiJr.png";

//DiceSFX
import DiceSFX from "../Assets/DiceImg/dicesfx.mp3";
import takeDice from "../Assets/DiceImg/takeDice.MP3";
import putDice from "../Assets/DiceImg/putDice.MP3";

//D4 Images
import D4_1 from "../Assets/DiceImg/d4_1.png";
import D4_2 from "../Assets/DiceImg/d4_2.png";
import D4_3 from "../Assets/DiceImg/d4_3.png";
import D4_4 from "../Assets/DiceImg/d4_4.png";
import D4_corner from "../Assets/DiceImg/d4_corner.png";

//D6 Images
import D6_one from "../Assets/DiceImg/D6_one.png";
import D6_two from "../Assets/DiceImg/D6_two.png";
import D6_three from "../Assets/DiceImg/D6_three.png";
import D6_four from "../Assets/DiceImg/D6_four.png";
import D6_five from "../Assets/DiceImg/D6_five.png";
import D6_six from "../Assets/DiceImg/D6_six.png";
import D6_corner from "../Assets/DiceImg/D6_corner.png";

//D8 Images
import D8_1 from "../Assets/DiceImg/d8_1.png";
import D8_2 from "../Assets/DiceImg/d8_2.png";
import D8_3 from "../Assets/DiceImg/d8_3.png";
import D8_4 from "../Assets/DiceImg/d8_4.png";
import D8_5 from "../Assets/DiceImg/d8_5.png";
import D8_6 from "../Assets/DiceImg/d8_6.png";
import D8_7 from "../Assets/DiceImg/d8_7.png";
import D8_8 from "../Assets/DiceImg/d8_8.png";
import D8_corner from "../Assets/DiceImg/d8_corner.png";

//D10 Images
import D10_0 from "../Assets/DiceImg/d10_0.png";
import D10_1 from "../Assets/DiceImg/d10_1.png";
import D10_2 from "../Assets/DiceImg/d10_2.png";
import D10_3 from "../Assets/DiceImg/d10_3.png";
import D10_4 from "../Assets/DiceImg/d10_4.png";
import D10_5 from "../Assets/DiceImg/d10_5.png";
import D10_6 from "../Assets/DiceImg/d10_6.png";
import D10_7 from "../Assets/DiceImg/d10_7.png";
import D10_8 from "../Assets/DiceImg/d10_8.png";
import D10_9 from "../Assets/DiceImg/d10_9.png";
import D10_10 from "../Assets/DiceImg/d10_10.png";

//D20 Images
import D20_1 from "../Assets/DiceImg/d20_1.png";
import D20_2 from "../Assets/DiceImg/d20_2.png";
import D20_3 from "../Assets/DiceImg/d20_3.png";
import D20_4 from "../Assets/DiceImg/d20_4.png";
import D20_5 from "../Assets/DiceImg/d20_5.png";
import D20_6 from "../Assets/DiceImg/d20_6.png";
import D20_7 from "../Assets/DiceImg/d20_7.png";
import D20_8 from "../Assets/DiceImg/d20_8.png";
import D20_9 from "../Assets/DiceImg/d20_9.png";
import D20_10 from "../Assets/DiceImg/d20_10.png";
import D20_11 from "../Assets/DiceImg/d20_11.png";
import D20_12 from "../Assets/DiceImg/d20_12.png";
import D20_13 from "../Assets/DiceImg/d20_13.png";
import D20_14 from "../Assets/DiceImg/d20_14.png";
import D20_15 from "../Assets/DiceImg/d20_15.png";
import D20_16 from "../Assets/DiceImg/d20_16.png";
import D20_17 from "../Assets/DiceImg/d20_17.png";
import D20_18 from "../Assets/DiceImg/d20_18.png";
import D20_19 from "../Assets/DiceImg/d20_19.png";
import D20_20 from "../Assets/DiceImg/d20_20.png";
import D20_corner from "../Assets/DiceImg/d20_corner.png";

//Coin Assets
import Coin1 from "../Assets/DiceImg/Coin1.png";
import Coin2 from "../Assets/DiceImg/Coin2.png";
import CoinMid from "../Assets/DiceImg/CoinMid.png";
import coinSFX from "../Assets/DiceImg/coinSFX.MP3";
...
export function useDices() {
  ...
  useEffect(() => {
    const spawnDice = () => {
      const d4Results = Array.from({ length: d4Count }, () =>
        Math.floor(Math.random() * 4)
      );
      const d6Results = Array.from({ length: d6Count }, () =>
        Math.floor(Math.random() * 6)
      );
      const d8Results = Array.from({ length: d8Count }, () =>
        Math.floor(Math.random() * 8)
      );
      const d10Results = Array.from({ length: d10Count }, () =>
        Math.floor(Math.random() * 10)
      );
      const d20Results = Array.from({ length: d20Count }, () =>
        Math.floor(Math.random() * 20)
      );
      const coinResults = Array.from({ length: coinCount }, () =>
  ...
  const rollDice = () => {
    ...
    const rollInterval = setInterval(() => {
      ...
      if (counter % 2 === 0) {
        ...
        d4Results = Array.from(
          { length: d4Count },
          () => D4Imgs[Math.floor(Math.random() * 4)]
        );
        d6Results = Array.from(
          { length: d6Count },
          () => D6Imgs[Math.floor(Math.random() * 6)]
        );
        d8Results = Array.from(
          { length: d8Count },
          () => D8Imgs[Math.floor(Math.random() * 8)]
        );
        d10Results = Array.from(
          { length: d10Count },
          () => D10Imgs[Math.floor(Math.random() * 10)]
        );
        d20Results = Array.from(
          { length: d20Count },
          () => D20Imgs[Math.floor(Math.random() * 20)]
        );
        coinResults = Array.from(
          { length: coinCount },
          () => CoinImgs[Math.floor(Math.random() * 2)]
        );
      }
      ...
      if (counter === 7) {
        //1 below the real number, as arrays start from 0.
        let newStats = { ...stats };
        ...
        d20Results.forEach((img) => {
          ...
          if (val === 19) {
            ...
            if (!newUnlocked[3]) {
              setAlertMsg(
                "Woah, you rolled a 20!. You are now the king of the Castle! Castle Roller added to Skins."
              );
            }
            newUnlocked[3] = true;
          }
          if (val === 0) {
            ...
            if (!newUnlocked[4]) {
              setAlertMsg(
                "Aww, you rolled a 1. Have Bakunawi Jr as a consolation. Added to Skins."
              );
            }
            newUnlocked[4] = true;
          }
      ...
      if (counter >= 8) {
        //change number to control amount of image switched. ENSURE THIS IS AN EVEN NUMBER
